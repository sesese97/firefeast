    ...
    <div className="container">
      <div className="manifiesto__grid">
        ...
        <div className="manifiesto__photo">
          <img
            src="assets/galeria-ahumados.jpg"
            alt="FireFeast preparando alimentos al fuego"
            loading="lazy"
...
const MENUS = {
  ...
  feast: {
    ...
    items: [
    {
      ...
      "Tacos de diezmillo",
      "Tacos de arrachera",
      "Ensalada de frutas caramelizadas"],
...
/* ---------------- OTROS SERVICIOS ---------------- */
const OTROS = [
{ tag: "AH", title: "Menú Ahumados", price: "Cotizar", sub: "por kilo / pedido", items: ["Brisket o Pork Belly", "Costillas ahumadas con salsa BBQ", "Pulled pork con slaw mexicano"] },
{ tag: "MD", title: "Mexa Deli", price: "Cotizar", sub: "por kilo / pedido", items: ["Barbacoa de res", "Cochinita pibil", "Birria"] },
{ tag: "GF", title: "Menú Gran Fiesta", price: "Cotizar", sub: "por kilo / pedido", items: ["Arroz meloso tipo paella", "Croquetas mixtas", "Chorizo español + mariscos", "Vegetales asados"] },
{ tag: "DG", title: "Desayunos Gourmet", price: "Cotizar", sub: "según pedido", items: ["Chilaquiles con proteína al carbón", "Frutas asadas de temporada"] }];
...
<section className="cta-final" id="contacto">
    <div className="cta-final__bg">
      <img
        src="assets/galeria-tabla.jpg"
        alt="Parrillada FireFeast lista para servir"
        loading="lazy"
        style={{ width: "100%", height: "100%", objectFit: "cover", display: "block" }}
      />
    </div>
